...
function showMessage(text, timeout, flag) {
    if(flag || sessionStorage.getItem('waifu-text') === '' || sessionStorage.getItem('waifu-text') === null){
        ...
        $('.waifu-tips').stop();
        $('.waifu-tips').html(text).fadeTo(200, 1, () => { console.log("show.callback"); hideMessage(timeout); });
    }
}
...
function hideMessage(timeout) {
    ...
    // $('.waifu-tips').delay(timeout).fadeTo(2000, 0, () => { console.log("hide.callback"); });
    setTimeout(() => {
        $('.waifu-tips').fadeTo(200, 0, () => { console.log("hide.callback"); });
    }, timeout);
}
